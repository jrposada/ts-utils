...
import { Expect, ExpectFalse, ExpectTrue } from "../utils/expect";

type A = ExpectFalse<Includes<["Kars", "Esidisi", "Wamuu", "Santana"], "Dio">>;
type B = ExpectFalse<Includes<["Kars", "Esidisi", "Wamuu", "Santana"], "Kars" | "Dio">>;
type C = ExpectFalse<Includes<[null], undefined>>;
type D = ExpectTrue<Includes<["Kars", "Esidisi", "Wamuu", "Santana"], "Kars">>
type E = ExpectTrue<Includes<[1, "Kars", "Esidisi", "Wamuu", "Santana"], "Kars" | 1>>
